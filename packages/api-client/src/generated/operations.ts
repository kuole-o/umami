...
export abstract class GeneratedUmamiClient {
   ...
   * `GET /api/websites/{websiteId}/main-metrics`
   */
  getWebsiteMainMetrics(
    input: OperationInput<'getWebsiteMainMetrics'>,
    options?: RequestOptions,
  ): Promise<OperationOutput<'getWebsiteMainMetrics'>> {
    return this.execute('getWebsiteMainMetrics', input, options);
  }
