...
export interface paths {
  ...
  '/api/websites/{websiteId}/main-metrics': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    /**
     * Get combined website headline metrics
     * @description Returns summary statistics together with ranked operating system, browser, and country metrics. Human-readable names and icon URLs are included for each ranked item.
     */
    get: operations['getWebsiteMainMetrics'];
    put?: never;
    post?: never;
    delete?: never;
    options?: never;
...
export interface operations {
  ...
  getWebsiteMainMetrics: {
    ...
    requestBody?: never;
    responses: {
      /** @description Combined website headline metrics. */
      200: {
        headers: {
          [name: string]: unknown;
        };
        content: {
          'application/json': components['schemas']['MainMetricsResponse'];
        };
      };
      /** @description Bad request. */
      400: {
